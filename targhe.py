...
def handleMessage(msg):
    ...
    while True:
        ...
        stringa="/home/pi/Desktop/timelapse/image{0:04d}.jpg".format(i)
        ...
        # Masking the part other than the number plate
            ...
            text = pytesseract.image_to_string(Cropped, lang='eng', config='--psm 13')
            result = "targa "+text
            print("Detected Number is:",text.strip())
            bot.sendPhoto(id, open(stringa, 'rb'))
...
bot = telepot.Bot("5240489208:AAFTDBP_t-iJapa0RnBWV7xux3aWPCW0uV4")
